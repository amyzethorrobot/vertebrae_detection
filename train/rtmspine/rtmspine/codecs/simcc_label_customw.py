...
class SimCCLabelCustomW(BaseKeypointCodec):
    ...
    def _map_coordinates(
        ...
        keypoint_weights = np.ones(keypoints_visible.shape) * self.visible_weight
        ...
        for n, k in product(range(N), range(K)):
            ...
            if keypoints_visible[n, k] < 0.5:
                ...
                if k in self.weight_mask:
                    keypoint_weights[n, k] = 0
                else:
                    keypoint_weights[n, k] = self.invisible_weight
